...
?>
    ...
    echo '<p>' . esc_html__("
This is your first step towards richer insights like daily totals, activity graphs, and more detailed ban reasons.", 'stopbadbots') . '</p>';
...
<?php
    ...
    } // End of if (!empty($results)) for Blocks Last 30 Days
    ...
    if (!empty($results)) {
        ...
        echo '</tbody>';
        echo '</table>';
    } // End of if (!empty($results)) for Blocks Last 24 Hours
    ...
    } // End of if (!empty($results)) for Last 100 Records
