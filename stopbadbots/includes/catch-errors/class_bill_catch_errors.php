...
function bill_install_mu_plugin()
{
    ...
    $stopbadbots_mu_plugin_dir = WP_PLUGIN_DIR . '/stopbadbots/includes/mu-plugins'; // Current path inside stopbadbots
    ...
    try {
        ...
        $source = $stopbadbots_mu_plugin_dir . '/' . $plugin_file;
    ...
    if (isset($_REQUEST)) {
        ...
        foreach ($errors as $error) {
            ...
            if ($log_error) {
                ...
                if ($stopbadbots_plugin_slug  == 'stopbadbots')
                    stopbadbotsErrorHandler('Javascript', $errorMessage, $errorURL, $errorLine);
