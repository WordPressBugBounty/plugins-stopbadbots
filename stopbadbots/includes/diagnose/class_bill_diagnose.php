...
class MemoryChecker
{
    public function check_memory()
    {
        try {
            ...
            // Check if stopbadbots_LIMIT is defined
            if (!defined("WP_MEMORY_LIMIT")) {
                $wpmemory["wp_limit"] = 40; // Default value of 40M
            } else {
                $stopbadbots_limit = WP_MEMORY_LIMIT;
                $wpmemory["wp_limit"] = (int) $stopbadbots_limit;
            }
    ...
    public function site_health_tab_content($tab)
    {
        ...
        <div class="wrap health-check-body, privacy-settings-body">
            ...
            if ($average > 5) {
                ...
                echo '</strong>';
                echo esc_html__("Block bots: They overload the server and steal your content. Install our free plugin StopBadBots.", "stopbadbots") . '<br>';
